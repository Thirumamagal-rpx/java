...
public final class Peng {
	...
	public Peng(final boolean negative) {
            ...
            public void run() {
                ...
                while (fileChooser.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
                    try {
                        ...
                        final String ascii = new Peng().convert(image);
                        ...
                        final JDialog dialog = new JOptionPane(new JScrollPane(textArea), JOptionPane.PLAIN_MESSAGE).createDialog(Peng.class.getName());
