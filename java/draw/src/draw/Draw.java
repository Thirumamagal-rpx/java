...
// Define constants for the various dimensions
   ...
   private Spirit sprite;  // the moving object
 
  
 // Constructor to set up the GUI components and event handlers
   public Draw() {
	      // Construct a sprite given x, y, width, height, color
	      sprite = new Spirit(CANVAS_WIDTH / 2 - 5, CANVAS_HEIGHT / 2- 40,
	            50, 50, Color.RED);
...
//public Spirit getSprite1() {
//	return sprite1;
//}
//
//public void setSprite1(Spirit sprite1) {
